...
class FamilyMoviesDetailScreen extends StatelessWidget {
  final String title;
  final String posterURL;
  const FamilyMoviesDetailScreen(
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 4),
                Text(
                  "Enjoy the magical adventure of $title, a captivating western movie that brings fun, emotions, and excitement to the screen for audiences of all ages",
                  style: Theme.of(context).textTheme.bodyLarge,
                ),
              ],
            ),
